...
<html lang="en">
<head>
<title>Sensitect - Category</title>
<meta charset="utf-8">
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Spare Parts</div>
		...
		<div class="products">
			<div class="container">
				...
				<div class="row products_row products_container grid">
								...
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											...
											<div class="product_category">In <a href="categories.html">Category</a></div>
										</div>
									</div>
					...
					<div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images/part7.jpeg" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
					...
					<div class="col-xl-4 col-md-6 grid-item new">
						<div class="product">
							<div class="product_image"><img src="images/part8.jpeg" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
